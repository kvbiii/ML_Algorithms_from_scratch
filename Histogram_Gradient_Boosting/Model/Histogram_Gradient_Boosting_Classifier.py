...
class Histogram_Gradient_Boosting_Classifier():
    def __init__(self, n_estimators=100, learning_rate=0.1, loss="log_loss", criterion="squared_error", max_depth=None, max_bins=255, categorical_features=None, random_state=17):
