...
class Cross_Validation_Gradient_Boosting_post_pruning():
    ...
    def find_alphas(self, X, y):
        ...
        for tree in range(0, self.algorithm.get_params()['n_estimators']):
            current_tree = self.algorithm.estimators_[tree][0]
    ...
    def compare_depth_and_alpha(self, X, y):
        ...
        for ccp_alpha in ccp_alphas_limited:
            ...
            for tree in range(0, algorithm.get_params()['n_estimators']):
                max_depths_accross_all_trees.append(algorithm.estimators_[tree][0].tree_.max_depth)
    ...
    def compare_nodes_and_alpha(self, X, y):
        ...
        for ccp_alpha in ccp_alphas_limited:
            ...
            for tree in range(0, algorithm.get_params()['n_estimators']):
                nodes_accross_all_trees.append(algorithm.estimators_[tree][0].tree_.node_count)
